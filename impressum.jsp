...
<body>
	<tag:navigationbar/>
	<h2 class="text-center" id="titleSite">Impressum</h2>
	<div style="padding-left:2%; padding-right:2%;">
		<article id="post-2383" class="post-2383 page type-page status-publish hentry entry">
		<div class="entry-content"><div class="entry-content-inner">
		<h2>Betreiber der Seite</h2>		
		<h3><strong>Schulleitung:</strong></h3>		
		<p>
			OStD Bertram Wolf, Schulleiter<br>N.N, stellvertretender Schulleiter
		</p>
		<p>
			Georg-Simon-Ohm-Berufskolleg der Stadt Köln<br>Westerwaldstraße 92<br>51105 Köln<br>Tel.: 0221-8391320<br>Fax: 0221-8391328<br>Email:&nbsp;<a href="mailto:buero@gso-koeln.de">buero@gso-koeln.de</a>
		</p>		
		<h3>Schulträger (Diensteanbieter im Sinne des RStV/TMG):</h3>
		<p>
			Stadt Köln&nbsp;- Amt für Schulentwicklung
		</p>
		<p>
			vertreten durch:&nbsp;<em>Oberbürgermeisterin Henriette Reker</em>
		</p>		
		<p>
			Willy-Brandt-Platz 3<br>
			50679 Köln<br>
			Telefon: (0221) 221-29204<br>
			Telefax: (0221) 221-29240<br>
			Email:&nbsp;<a href="mailto:schulentwicklungsamt@stadt-koeln.de">schulentwicklungsamt@stadt-koeln.de</a>
		</p>
		
		<h3>Inhaltliche Verantwortung nach § 55 Abs. 2 RStV:</h3>
		<p>OStD Bertram Wolf</p>
				
		<h2>Rechtliche Hinweise</h2>		
		<p>
			1. Haftungsbeschränkung<br>Die Inhalte dieser Website werden mit größtmöglicher Sorgfalt erstellt. 
		...
		<p>
			...
			Lediglich die Herstellung von Kopien und Downloads für den persönlichen, privaten und nicht kommerziellen Gebrauch ist erlaubt.<br>
